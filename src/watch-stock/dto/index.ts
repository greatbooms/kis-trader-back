export { WatchStockType } from './watch-stock.object';
export { CreateWatchStockInput } from './create-watch-stock.input';
export { UpdateWatchStockInput } from './update-watch-stock.input';

...
- **페이지 전용 타입은 `pages/types/`에 1타입 1파일**, 시뮬레이션처럼 페이지가 sub-component를 가지면 그 폴더 안 `types/`에 둔다 (예: `pages/simulation/types/simulation.types.ts`). 루트 CLAUDE.md의 프론트엔드 타입 규칙 따름.

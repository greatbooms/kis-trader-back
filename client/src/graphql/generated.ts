...
export type AssignBrokerContextInput = {
  contextToken: Scalars['String']['input'];
...
export type BrokerOrderCandidateIdentityInput = {
  brokerOrderDate: Scalars['String']['input'];
  exchangeCode: Scalars['String']['input'];
  orderNo: Scalars['String']['input'];
  tradeRecordId: Scalars['ID']['input'];
};

export type BrokerOrderCandidateInspectionType = {
  __typename?: 'BrokerOrderCandidateInspectionType';
  candidates: Array<BrokerOrderCandidateType>;
  inspectedAt: Scalars['DateTime']['output'];
  recoveryItem: BrokerOrderRecoveryItemType;
};

export type BrokerOrderCandidateType = {
  __typename?: 'BrokerOrderCandidateType';
  collisionType?: Maybe<Scalars['String']['output']>;
  exchangeCode: Scalars['String']['output'];
  existingTradeRecordId?: Maybe<Scalars['ID']['output']>;
  filledPrice?: Maybe<Scalars['Float']['output']>;
  ...
  rejectionState: Scalars['String']['output'];
...
export type BrokerOrderRecoveryItemType = {
  ...
  brokerOrderTime?: Maybe<Scalars['String']['output']>;
  cancellationMessage?: Maybe<Scalars['String']['output']>;
  cancellationResolvedAt?: Maybe<Scalars['DateTime']['output']>;
  cancellationResolvedBy?: Maybe<Scalars['String']['output']>;
  cancellationStartedAt?: Maybe<Scalars['DateTime']['output']>;
  cancellationStatus?: Maybe<CancellationAttemptStatus>;
  createdAt: Scalars['DateTime']['output'];
  currentBrokerEnvironment?: Maybe<BrokerEnvironment>;
  exchangeCode: Scalars['String']['output'];
  lifecycle: Scalars['String']['output'];
  market: Market;
  maskedCurrentAccount?: Maybe<Scalars['String']['output']>;
  ...
  submissionResolution?: Maybe<SubmissionResolution>;
  submissionResolvedAt?: Maybe<Scalars['DateTime']['output']>;
  submissionResolvedBy?: Maybe<Scalars['String']['output']>;
  submissionStartedAt?: Maybe<Scalars['DateTime']['output']>;
  tradeRecordId: Scalars['ID']['output'];
  updatedAt: Scalars['DateTime']['output'];
};

export type BrokerOrderRecoveryTradeInput = {
  tradeRecordId: Scalars['ID']['input'];
};
...
export type CashBalanceType = {
  ...
  /** 일반 주문가능금액 */
  generalOrderableAmount?: Maybe<Scalars['Float']['output']>;
  /** 통합 주문가능금액 */
  integratedOrderableAmount?: Maybe<Scalars['Float']['output']>;
  /** 외화 증거금액 */
  marginAmount?: Maybe<Scalars['Float']['output']>;
  market: Market;
  /** 주문가능금액 */
  orderableAmount?: Maybe<Scalars['Float']['output']>;
  /** 미결제 매수금액 */
  pendingBuyAmount?: Maybe<Scalars['Float']['output']>;
  /** 미결제 매도금액 */
  pendingSellAmount?: Maybe<Scalars['Float']['output']>;
  /** 외화 미수금액 */
  receivableAmount?: Maybe<Scalars['Float']['output']>;
...
export type MatchExistingBrokerOrderInput = {
  brokerOrderDate: Scalars['String']['input'];
  exchangeCode: Scalars['String']['input'];
  existingTradeRecordId: Scalars['ID']['input'];
  orderNo: Scalars['String']['input'];
  tradeRecordId: Scalars['ID']['input'];
};
...
export type Mutation = {
  __typename?: 'Mutation';
  assignCurrentBrokerContext: BrokerOrderRecoveryItemType;
  cancelTradeOrder: CancelTradeOrderResult;
  confirmBrokerOrderMatchesExisting: BrokerOrderRecoveryItemType;
  confirmBrokerOrderNotSubmitted: BrokerOrderRecoveryItemType;
  confirmCancellationNotAccepted: BrokerOrderRecoveryItemType;
  ...
  inspectBrokerOrderCandidates: BrokerOrderCandidateInspectionType;
  inspectUnknownCancellation: BrokerOrderRecoveryItemType;
  linkBrokerOrderCandidate: BrokerOrderRecoveryItemType;
  login: AuthPayload;
  logout: AuthPayload;
...
export type MutationAssignCurrentBrokerContextArgs = {
...
export type MutationConfirmBrokerOrderMatchesExistingArgs = {
  input: MatchExistingBrokerOrderInput;
};


export type MutationConfirmBrokerOrderNotSubmittedArgs = {
  input: BrokerOrderRecoveryTradeInput;
};


export type MutationConfirmCancellationNotAcceptedArgs = {
  input: BrokerOrderRecoveryTradeInput;
};
...
export type MutationInspectBrokerOrderCandidatesArgs = {
  input: BrokerOrderRecoveryTradeInput;
};


export type MutationInspectUnknownCancellationArgs = {
  input: BrokerOrderRecoveryTradeInput;
};


export type MutationLinkBrokerOrderCandidateArgs = {
...
export type Query = {
  ...
  brokerOrderRecoveryItems: Array<BrokerOrderRecoveryItemType>;
...
export type BrokerOrderRecoveryItemFieldsFragment = { __typename?: 'BrokerOrderRecoveryItemType', tradeRecordId: string, lifecycle: string, market: Market, exchangeCode: string, stockCode: string, stockName: string, side: Side, orderType: OrderType, quantity: number, price: number, orderNo?: string | null, status: OrderStatus, submissionStartedAt?: any | null, brokerOrderDate?: string | null, brokerOrderTime?: string | null, submissionResolvedAt?: any | null, submissionResolvedBy?: string | null, submissionResolution?: SubmissionResolution | null, cancellationStatus?: CancellationAttemptStatus | null, cancellationStartedAt?: any | null, cancellationResolvedAt?: any | null, cancellationResolvedBy?: string | null, cancellationMessage?: string | null, brokerContextAssigned: boolean, currentBrokerEnvironment?: BrokerEnvironment | null, maskedCurrentAccount?: string | null, brokerContextMatchesCurrent?: boolean | null, createdAt: any, updatedAt: any };

export type GetBrokerOrderRecoveryItemsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetBrokerOrderRecoveryItemsQuery = { __typename?: 'Query', brokerOrderRecoveryItems: Array<{ __typename?: 'BrokerOrderRecoveryItemType', tradeRecordId: string, lifecycle: string, market: Market, exchangeCode: string, stockCode: string, stockName: string, side: Side, orderType: OrderType, quantity: number, price: number, orderNo?: string | null, status: OrderStatus, submissionStartedAt?: any | null, brokerOrderDate?: string | null, brokerOrderTime?: string | null, submissionResolvedAt?: any | null, submissionResolvedBy?: string | null, submissionResolution?: SubmissionResolution | null, cancellationStatus?: CancellationAttemptStatus | null, cancellationStartedAt?: any | null, cancellationResolvedAt?: any | null, cancellationResolvedBy?: string | null, cancellationMessage?: string | null, brokerContextAssigned: boolean, currentBrokerEnvironment?: BrokerEnvironment | null, maskedCurrentAccount?: string | null, brokerContextMatchesCurrent?: boolean | null, createdAt: any, updatedAt: any }> };

export type GetCurrentBrokerContextPreviewQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCurrentBrokerContextPreviewQuery = { __typename?: 'Query', currentBrokerContextPreview: { __typename?: 'BrokerContextPreviewType', environment: BrokerEnvironment, maskedAccount: string, contextToken: string } };

export type InspectBrokerOrderCandidatesMutationVariables = Exact<{
  input: BrokerOrderRecoveryTradeInput;
}>;


export type InspectBrokerOrderCandidatesMutation = { __typename?: 'Mutation', inspectBrokerOrderCandidates: { __typename?: 'BrokerOrderCandidateInspectionType', inspectedAt: any, recoveryItem: { __typename?: 'BrokerOrderRecoveryItemType', tradeRecordId: string, lifecycle: string, market: Market, exchangeCode: string, stockCode: string, stockName: string, side: Side, orderType: OrderType, quantity: number, price: number, orderNo?: string | null, status: OrderStatus, submissionStartedAt?: any | null, brokerOrderDate?: string | null, brokerOrderTime?: string | null, submissionResolvedAt?: any | null, submissionResolvedBy?: string | null, submissionResolution?: SubmissionResolution | null, cancellationStatus?: CancellationAttemptStatus | null, cancellationStartedAt?: any | null, cancellationResolvedAt?: any | null, cancellationResolvedBy?: string | null, cancellationMessage?: string | null, brokerContextAssigned: boolean, currentBrokerEnvironment?: BrokerEnvironment | null, maskedCurrentAccount?: string | null, brokerContextMatchesCurrent?: boolean | null, createdAt: any, updatedAt: any }, candidates: Array<{ __typename?: 'BrokerOrderCandidateType', orderNo: string, stockCode: string, side: Side, orderQuantity: number, filledQuantity: number, remainingQuantity: number, orderPrice?: number | null, filledPrice?: number | null, exchangeCode: string, orderDate: string, orderTime: string, rejectionState: string, rejected?: boolean | null, rejectedReason?: string | null, existingTradeRecordId?: string | null, collisionType?: string | null }> } };

export type AssignCurrentBrokerContextMutationVariables = Exact<{
  input: AssignBrokerContextInput;
}>;


export type AssignCurrentBrokerContextMutation = { __typename?: 'Mutation', assignCurrentBrokerContext: { __typename?: 'BrokerOrderRecoveryItemType', tradeRecordId: string, lifecycle: string, market: Market, exchangeCode: string, stockCode: string, stockName: string, side: Side, orderType: OrderType, quantity: number, price: number, orderNo?: string | null, status: OrderStatus, submissionStartedAt?: any | null, brokerOrderDate?: string | null, brokerOrderTime?: string | null, submissionResolvedAt?: any | null, submissionResolvedBy?: string | null, submissionResolution?: SubmissionResolution | null, cancellationStatus?: CancellationAttemptStatus | null, cancellationStartedAt?: any | null, cancellationResolvedAt?: any | null, cancellationResolvedBy?: string | null, cancellationMessage?: string | null, brokerContextAssigned: boolean, currentBrokerEnvironment?: BrokerEnvironment | null, maskedCurrentAccount?: string | null, brokerContextMatchesCurrent?: boolean | null, createdAt: any, updatedAt: any } };

export type LinkBrokerOrderCandidateMutationVariables = Exact<{
  input: BrokerOrderCandidateIdentityInput;
}>;


export type LinkBrokerOrderCandidateMutation = { __typename?: 'Mutation', linkBrokerOrderCandidate: { __typename?: 'BrokerOrderRecoveryItemType', tradeRecordId: string, lifecycle: string, market: Market, exchangeCode: string, stockCode: string, stockName: string, side: Side, orderType: OrderType, quantity: number, price: number, orderNo?: string | null, status: OrderStatus, submissionStartedAt?: any | null, brokerOrderDate?: string | null, brokerOrderTime?: string | null, submissionResolvedAt?: any | null, submissionResolvedBy?: string | null, submissionResolution?: SubmissionResolution | null, cancellationStatus?: CancellationAttemptStatus | null, cancellationStartedAt?: any | null, cancellationResolvedAt?: any | null, cancellationResolvedBy?: string | null, cancellationMessage?: string | null, brokerContextAssigned: boolean, currentBrokerEnvironment?: BrokerEnvironment | null, maskedCurrentAccount?: string | null, brokerContextMatchesCurrent?: boolean | null, createdAt: any, updatedAt: any } };

export type ConfirmBrokerOrderNotSubmittedMutationVariables = Exact<{
  input: BrokerOrderRecoveryTradeInput;
}>;


export type ConfirmBrokerOrderNotSubmittedMutation = { __typename?: 'Mutation', confirmBrokerOrderNotSubmitted: { __typename?: 'BrokerOrderRecoveryItemType', tradeRecordId: string, lifecycle: string, market: Market, exchangeCode: string, stockCode: string, stockName: string, side: Side, orderType: OrderType, quantity: number, price: number, orderNo?: string | null, status: OrderStatus, submissionStartedAt?: any | null, brokerOrderDate?: string | null, brokerOrderTime?: string | null, submissionResolvedAt?: any | null, submissionResolvedBy?: string | null, submissionResolution?: SubmissionResolution | null, cancellationStatus?: CancellationAttemptStatus | null, cancellationStartedAt?: any | null, cancellationResolvedAt?: any | null, cancellationResolvedBy?: string | null, cancellationMessage?: string | null, brokerContextAssigned: boolean, currentBrokerEnvironment?: BrokerEnvironment | null, maskedCurrentAccount?: string | null, brokerContextMatchesCurrent?: boolean | null, createdAt: any, updatedAt: any } };

export type ConfirmBrokerOrderMatchesExistingMutationVariables = Exact<{
  input: MatchExistingBrokerOrderInput;
}>;


export type ConfirmBrokerOrderMatchesExistingMutation = { __typename?: 'Mutation', confirmBrokerOrderMatchesExisting: { __typename?: 'BrokerOrderRecoveryItemType', tradeRecordId: string, lifecycle: string, market: Market, exchangeCode: string, stockCode: string, stockName: string, side: Side, orderType: OrderType, quantity: number, price: number, orderNo?: string | null, status: OrderStatus, submissionStartedAt?: any | null, brokerOrderDate?: string | null, brokerOrderTime?: string | null, submissionResolvedAt?: any | null, submissionResolvedBy?: string | null, submissionResolution?: SubmissionResolution | null, cancellationStatus?: CancellationAttemptStatus | null, cancellationStartedAt?: any | null, cancellationResolvedAt?: any | null, cancellationResolvedBy?: string | null, cancellationMessage?: string | null, brokerContextAssigned: boolean, currentBrokerEnvironment?: BrokerEnvironment | null, maskedCurrentAccount?: string | null, brokerContextMatchesCurrent?: boolean | null, createdAt: any, updatedAt: any } };

export type InspectUnknownCancellationMutationVariables = Exact<{
  input: BrokerOrderRecoveryTradeInput;
}>;


export type InspectUnknownCancellationMutation = { __typename?: 'Mutation', inspectUnknownCancellation: { __typename?: 'BrokerOrderRecoveryItemType', tradeRecordId: string, lifecycle: string, market: Market, exchangeCode: string, stockCode: string, stockName: string, side: Side, orderType: OrderType, quantity: number, price: number, orderNo?: string | null, status: OrderStatus, submissionStartedAt?: any | null, brokerOrderDate?: string | null, brokerOrderTime?: string | null, submissionResolvedAt?: any | null, submissionResolvedBy?: string | null, submissionResolution?: SubmissionResolution | null, cancellationStatus?: CancellationAttemptStatus | null, cancellationStartedAt?: any | null, cancellationResolvedAt?: any | null, cancellationResolvedBy?: string | null, cancellationMessage?: string | null, brokerContextAssigned: boolean, currentBrokerEnvironment?: BrokerEnvironment | null, maskedCurrentAccount?: string | null, brokerContextMatchesCurrent?: boolean | null, createdAt: any, updatedAt: any } };

export type ConfirmCancellationNotAcceptedMutationVariables = Exact<{
  input: BrokerOrderRecoveryTradeInput;
}>;


export type ConfirmCancellationNotAcceptedMutation = { __typename?: 'Mutation', confirmCancellationNotAccepted: { __typename?: 'BrokerOrderRecoveryItemType', tradeRecordId: string, lifecycle: string, market: Market, exchangeCode: string, stockCode: string, stockName: string, side: Side, orderType: OrderType, quantity: number, price: number, orderNo?: string | null, status: OrderStatus, submissionStartedAt?: any | null, brokerOrderDate?: string | null, brokerOrderTime?: string | null, submissionResolvedAt?: any | null, submissionResolvedBy?: string | null, submissionResolution?: SubmissionResolution | null, cancellationStatus?: CancellationAttemptStatus | null, cancellationStartedAt?: any | null, cancellationResolvedAt?: any | null, cancellationResolvedBy?: string | null, cancellationMessage?: string | null, brokerContextAssigned: boolean, currentBrokerEnvironment?: BrokerEnvironment | null, maskedCurrentAccount?: string | null, brokerContextMatchesCurrent?: boolean | null, createdAt: any, updatedAt: any } };
...
export const GetBrokerOrderRecoveryItemsDocument = gql`
    query GetBrokerOrderRecoveryItems {
  brokerOrderRecoveryItems {
    ...BrokerOrderRecoveryItemFields
  }
}
    ${BrokerOrderRecoveryItemFieldsFragmentDoc}`;

/**
 * __useGetBrokerOrderRecoveryItemsQuery__
 *
 * To run a query within a React component, call `useGetBrokerOrderRecoveryItemsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBrokerOrderRecoveryItemsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetBrokerOrderRecoveryItemsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBrokerOrderRecoveryItemsQuery, GetBrokerOrderRecoveryItemsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetBrokerOrderRecoveryItemsQuery, GetBrokerOrderRecoveryItemsQueryVariables>(GetBrokerOrderRecoveryItemsDocument, options);
      }
export function useGetBrokerOrderRecoveryItemsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBrokerOrderRecoveryItemsQuery, GetBrokerOrderRecoveryItemsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetBrokerOrderRecoveryItemsQuery, GetBrokerOrderRecoveryItemsQueryVariables>(GetBrokerOrderRecoveryItemsDocument, options);
        }
// @ts-ignore
export function useGetBrokerOrderRecoveryItemsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetBrokerOrderRecoveryItemsQuery, GetBrokerOrderRecoveryItemsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetBrokerOrderRecoveryItemsQuery, GetBrokerOrderRecoveryItemsQueryVariables>;
export function useGetBrokerOrderRecoveryItemsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetBrokerOrderRecoveryItemsQuery, GetBrokerOrderRecoveryItemsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetBrokerOrderRecoveryItemsQuery | undefined, GetBrokerOrderRecoveryItemsQueryVariables>;
export function useGetBrokerOrderRecoveryItemsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetBrokerOrderRecoveryItemsQuery, GetBrokerOrderRecoveryItemsQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetBrokerOrderRecoveryItemsQuery, GetBrokerOrderRecoveryItemsQueryVariables>(GetBrokerOrderRecoveryItemsDocument, options);
        }
export type GetBrokerOrderRecoveryItemsQueryHookResult = ReturnType<typeof useGetBrokerOrderRecoveryItemsQuery>;
export type GetBrokerOrderRecoveryItemsLazyQueryHookResult = ReturnType<typeof useGetBrokerOrderRecoveryItemsLazyQuery>;
export type GetBrokerOrderRecoveryItemsSuspenseQueryHookResult = ReturnType<typeof useGetBrokerOrderRecoveryItemsSuspenseQuery>;
...
/**
 * __useGetCurrentBrokerContextPreviewQuery__
 *
 * To run a query within a React component, call `useGetCurrentBrokerContextPreviewQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCurrentBrokerContextPreviewQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetCurrentBrokerContextPreviewQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetCurrentBrokerContextPreviewQuery, GetCurrentBrokerContextPreviewQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetCurrentBrokerContextPreviewQuery, GetCurrentBrokerContextPreviewQueryVariables>(GetCurrentBrokerContextPreviewDocument, options);
      }
export function useGetCurrentBrokerContextPreviewLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetCurrentBrokerContextPreviewQuery, GetCurrentBrokerContextPreviewQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetCurrentBrokerContextPreviewQuery, GetCurrentBrokerContextPreviewQueryVariables>(GetCurrentBrokerContextPreviewDocument, options);
        }
// @ts-ignore
export function useGetCurrentBrokerContextPreviewSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetCurrentBrokerContextPreviewQuery, GetCurrentBrokerContextPreviewQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetCurrentBrokerContextPreviewQuery, GetCurrentBrokerContextPreviewQueryVariables>;
export function useGetCurrentBrokerContextPreviewSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetCurrentBrokerContextPreviewQuery, GetCurrentBrokerContextPreviewQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetCurrentBrokerContextPreviewQuery | undefined, GetCurrentBrokerContextPreviewQueryVariables>;
export function useGetCurrentBrokerContextPreviewSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetCurrentBrokerContextPreviewQuery, GetCurrentBrokerContextPreviewQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetCurrentBrokerContextPreviewQuery, GetCurrentBrokerContextPreviewQueryVariables>(GetCurrentBrokerContextPreviewDocument, options);
        }
export type GetCurrentBrokerContextPreviewQueryHookResult = ReturnType<typeof useGetCurrentBrokerContextPreviewQuery>;
export type GetCurrentBrokerContextPreviewLazyQueryHookResult = ReturnType<typeof useGetCurrentBrokerContextPreviewLazyQuery>;
export type GetCurrentBrokerContextPreviewSuspenseQueryHookResult = ReturnType<typeof useGetCurrentBrokerContextPreviewSuspenseQuery>;
export const InspectBrokerOrderCandidatesDocument = gql`
...
/**
 * __useInspectBrokerOrderCandidatesMutation__
 *
 * To run a mutation, you first call `useInspectBrokerOrderCandidatesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useInspectBrokerOrderCandidatesMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [inspectBrokerOrderCandidatesMutation, { data, loading, error }] = useInspectBrokerOrderCandidatesMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useInspectBrokerOrderCandidatesMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<InspectBrokerOrderCandidatesMutation, InspectBrokerOrderCandidatesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<InspectBrokerOrderCandidatesMutation, InspectBrokerOrderCandidatesMutationVariables>(InspectBrokerOrderCandidatesDocument, options);
      }
export type InspectBrokerOrderCandidatesMutationHookResult = ReturnType<typeof useInspectBrokerOrderCandidatesMutation>;
export const AssignCurrentBrokerContextDocument = gql`
...
/**
 * __useAssignCurrentBrokerContextMutation__
 *
 * To run a mutation, you first call `useAssignCurrentBrokerContextMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAssignCurrentBrokerContextMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [assignCurrentBrokerContextMutation, { data, loading, error }] = useAssignCurrentBrokerContextMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAssignCurrentBrokerContextMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AssignCurrentBrokerContextMutation, AssignCurrentBrokerContextMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<AssignCurrentBrokerContextMutation, AssignCurrentBrokerContextMutationVariables>(AssignCurrentBrokerContextDocument, options);
      }
export type AssignCurrentBrokerContextMutationHookResult = ReturnType<typeof useAssignCurrentBrokerContextMutation>;
export const LinkBrokerOrderCandidateDocument = gql`
...
/**
 * __useLinkBrokerOrderCandidateMutation__
 *
 * To run a mutation, you first call `useLinkBrokerOrderCandidateMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useLinkBrokerOrderCandidateMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [linkBrokerOrderCandidateMutation, { data, loading, error }] = useLinkBrokerOrderCandidateMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useLinkBrokerOrderCandidateMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<LinkBrokerOrderCandidateMutation, LinkBrokerOrderCandidateMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<LinkBrokerOrderCandidateMutation, LinkBrokerOrderCandidateMutationVariables>(LinkBrokerOrderCandidateDocument, options);
      }
export type LinkBrokerOrderCandidateMutationHookResult = ReturnType<typeof useLinkBrokerOrderCandidateMutation>;
export const ConfirmBrokerOrderNotSubmittedDocument = gql`
...
/**
 * __useConfirmBrokerOrderNotSubmittedMutation__
 *
 * To run a mutation, you first call `useConfirmBrokerOrderNotSubmittedMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useConfirmBrokerOrderNotSubmittedMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [confirmBrokerOrderNotSubmittedMutation, { data, loading, error }] = useConfirmBrokerOrderNotSubmittedMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useConfirmBrokerOrderNotSubmittedMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ConfirmBrokerOrderNotSubmittedMutation, ConfirmBrokerOrderNotSubmittedMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<ConfirmBrokerOrderNotSubmittedMutation, ConfirmBrokerOrderNotSubmittedMutationVariables>(ConfirmBrokerOrderNotSubmittedDocument, options);
      }
export type ConfirmBrokerOrderNotSubmittedMutationHookResult = ReturnType<typeof useConfirmBrokerOrderNotSubmittedMutation>;
export const ConfirmBrokerOrderMatchesExistingDocument = gql`
...
/**
 * __useConfirmBrokerOrderMatchesExistingMutation__
 *
 * To run a mutation, you first call `useConfirmBrokerOrderMatchesExistingMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useConfirmBrokerOrderMatchesExistingMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [confirmBrokerOrderMatchesExistingMutation, { data, loading, error }] = useConfirmBrokerOrderMatchesExistingMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useConfirmBrokerOrderMatchesExistingMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ConfirmBrokerOrderMatchesExistingMutation, ConfirmBrokerOrderMatchesExistingMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<ConfirmBrokerOrderMatchesExistingMutation, ConfirmBrokerOrderMatchesExistingMutationVariables>(ConfirmBrokerOrderMatchesExistingDocument, options);
      }
export type ConfirmBrokerOrderMatchesExistingMutationHookResult = ReturnType<typeof useConfirmBrokerOrderMatchesExistingMutation>;
export const InspectUnknownCancellationDocument = gql`
...
/**
 * __useInspectUnknownCancellationMutation__
 *
 * To run a mutation, you first call `useInspectUnknownCancellationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useInspectUnknownCancellationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [inspectUnknownCancellationMutation, { data, loading, error }] = useInspectUnknownCancellationMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useInspectUnknownCancellationMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<InspectUnknownCancellationMutation, InspectUnknownCancellationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<InspectUnknownCancellationMutation, InspectUnknownCancellationMutationVariables>(InspectUnknownCancellationDocument, options);
      }
export type InspectUnknownCancellationMutationHookResult = ReturnType<typeof useInspectUnknownCancellationMutation>;
export const ConfirmCancellationNotAcceptedDocument = gql`
...
/**
 * __useConfirmCancellationNotAcceptedMutation__
 *
 * To run a mutation, you first call `useConfirmCancellationNotAcceptedMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useConfirmCancellationNotAcceptedMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [confirmCancellationNotAcceptedMutation, { data, loading, error }] = useConfirmCancellationNotAcceptedMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useConfirmCancellationNotAcceptedMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ConfirmCancellationNotAcceptedMutation, ConfirmCancellationNotAcceptedMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<ConfirmCancellationNotAcceptedMutation, ConfirmCancellationNotAcceptedMutationVariables>(ConfirmCancellationNotAcceptedDocument, options);
      }
export type ConfirmCancellationNotAcceptedMutationHookResult = ReturnType<typeof useConfirmCancellationNotAcceptedMutation>;
